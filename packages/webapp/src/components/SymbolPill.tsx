 ...
 *
 * Project tokens (ONyc / wONyc) reuse the OnRe artwork — they're the
 * same underlying yield asset wrapped at different stages of the
 * bridge. USDC.s reuses Circle's USDC mark for the same reason
 ...
 * asset identity glanceable. Replaces the previous text-only `<Badge>`
 * usage in the deposit/withdraw form.
 */
